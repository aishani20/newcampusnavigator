  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8 flex flex-wrap gap-4">
      {programmingBooks.map(book => (
        <div key={book.id} className="book-card w-64 p-4 border rounded-lg shadow-md  focus:border-blue-300 dark:bg-[#32373A] bg-white dark:border-[#3B4143] ">
          ...
          <a href={book.downloadUrl} className="mt-4 block w-full text-center py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-700 transition duration-300 ease-in-out dark:bg-[#1544CB]" download>Download</a>
        </div>
      ))}
      </div>
    </div>
